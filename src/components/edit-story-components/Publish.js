...
const Publish = (props) => {
  const user = User();
  const [tags, setTags] = useState(props.pageProps.tags);
  const [title, setTitle] = useState(props.pageProps.title);
  const [subTitle, setSubTitle] = useState(props.pageProps.subtitle);
      ...
      <div className="new-story__publish--settings">
        ...
        <div className="new-story__story--preview">
          ...
          <div className="new-story__story--title">
            <input type="text" value={title} placeholder="Change your title" />
            <textarea
              type="text"
              value={subTitle}
